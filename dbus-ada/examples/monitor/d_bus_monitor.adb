...
begin
   ...
   Connection.Add_Match
     (Connection => Conn,
      Rule       => "eavesdrop=true, type='method_call'");
   Connection.Add_Match
     (Connection => Conn,
      Rule       => "eavesdrop=true, type='method_return'");
   Connection.Add_Match
     (Connection => Conn,
      Rule       => "eavesdrop=true, type='error'");
   Connection.Dispatch
     (Connection => Conn,
      Callback   => Callbacks.Print'Access);
end D_Bus_Monitor;
